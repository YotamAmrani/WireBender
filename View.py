...
class View:
    ...
    def draw_metal_line(self, start_position, end_position):
        self.draw_line_round_corners_polygon(self._model.screen, start_position, end_position, LINE_COLOR, LINE_WIDTH)
    ...
    def draw_current_line(self):
        ...
        if (self._model.segment_length > SPINNER_DISTANCE):
            ...
            x = radar_center[0] + math.sin(math.radians(self._model.bender_angle)) * (SPINNER_DISTANCE - self._model.segment_length)
            y = radar_center[1] + math.cos(math.radians(self._model.bender_angle)) * (SPINNER_DISTANCE - self._model.segment_length)
    ...
    def draw_current_spinner(self):
        ...
        rotated = pygame.transform.rotate(spinner, self._model.bender_angle)
